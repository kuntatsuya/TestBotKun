...
cl = LINETCR.LINE() #Dito
cl.login(token="Em3Nz3ODdtDZop7roIv4.A1X3xBcnAw4T7J4lRBa1Ta.9L69HCV6MRo2I2YVmvESVDECnb9dZTS7D9apOlvpgxI=")
cl.loginResult()

ki = LINETCR.LINE() #DitoV1
ki.login(token="EmRdzGDYvmdtgOrFj97a.AuWrGLK5lmNYkKt7H98l6G.qLMxDaHOp0KnJxbLO5fpYgZJJxW7yjsvJDKT7BHKyP4==")
ki.loginResult()

kk = LINETCR.LINE() #DitoV2
kk.login(token="EmkpF9fjHPWNlNnemiGa.4RuDAgoMLy9J7YwOq/jv2G.I2Au7QA3xjxgqzKomljKxJdhBteA/hoW00YJvulizw0=")
kk.loginResult()

kc = LINETCR.LINE() #DitoV3
kc.login(token="Em2Oyc1LpyUEyRgyrGCf.FgWxtqxIBHPGwLQiFX+WhW.M0MZlosGDY3pqn9KB/hTcA2mGgSy4wgs6HrZV2grGqY=")
kc.loginResult()

ks = LINETCR.LINE() #DitoV4
ks.login(token="EmjP43zEVdXFpWyEIXc2.7lYlN/j/7cYUzS6beSaEGG.tgZMAIspc2WaSKEAuEMd2HAtB50fCiSI2N3dIHkG5GQ")
ks.loginResult()

print "login success dit"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""                   Đįτσσσ┏o┛ BOT
Owner BOT : Dito Paling Maniz SE-LINE 😝
-======================-

∆ Command For All Member ∆
-======================-
...
mid = cl.getProfile().mid #Dito
Amid = ki.getProfile().mid #DitoV1
Bmid = kk.getProfile().mid #DitoV2
Cmid = kc.getProfile().mid #DitoV3
Dmid = ks.getProfile().mid #DitoV4

Bots=[mid,Amid,Bmid,Cmid,Dmid]
admin=["uf2168bf25bf06251ed1fbfb6b7152412","u01e0a371b10d22f0e96a64ecef40cdaf","u7a425a5736f0ef7a3c41e09a2adbb726","ue2638af0e6a7564f5042f61dba65e631","uafc9f1ff4d78932775e9e21d6c839451","u990308c2d35d44bf3843988bb8bdbf80"]
owner=["uf2168bf25bf06251ed1fbfb6b7152412"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':""" CIE YANG NGE ADD GUE 😝😝
≫ MAAF KALO GA BALES CHATNYA , SOALNYA AKU CUMA BOT :) ≪
                     ≫ DITO INSIDE :( ≪

Sell stiker & theme line ( Region indo )
...
1000© 60k
Berlaku kelipatan
Payment Via TELKOMSEL

kui pm aja langsung : http://line.me/ti/p/~ditopermana69

Testi ?? by pm :)

NO KEEP and BUKAN BERUPA COIN , MELAINKAN STIKERNYA / THEME NYA DI GIFT
""",
    "lang":"JP",
        ...
        if op.type == 13:
          if wait["Protectcancl"] == True:
            ...
            if op.param2 in admin:
              ...
              random.choice(KAC).sendText(op.param1, "Mau invite siapa si??\nLu bukan admin :v\nJadi gue cancel aja ya😛")
...
#--------------------------------
    ...
    #-----------------=Selesai=------------------
              ...
              if msg.from_ in admin:
            ...
            elif msg.text in ["Dito buka qr","Dito open qr"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done Sayang")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done Sayang")
                    else:
            ...
            elif msg.text in ["Dito open qr","Dito buka qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done Sayang")
                    else:
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Hanya Admin Yang bisa Gunain Perintah ini.")
            elif msg.text in ["Dito close qr","Dito tutup qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Dito tutup qr","Dito tutup qr"]:
                if msg.toType == 2:
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"Semua undangan telah di batalkan hehe")
                else:
...
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
            ...
            elif msg.text == "Cek Reader":
              if msg.from_ in admin:
                cl.sendText(msg.to, "Ketik Cek Sider untuk mengetahui siapa yg nyider :V")
                try:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "↪ Di Read Oleh ↩%s\n|| By : -TEAM Đįτσσσ┏o┛ BOT- ||\n\n💔 Pelaku Sider 💔\n%s-= SIDER =-\n•Bintitan\n•Cepet Tua\n•Jomblo Terus\n•Cepet Mati\n\nNOW TIME\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Ketik Cek Reader dulu Koplak\nBaru Ketik Cek Sider\nDASAR PIKUN ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","Join dit","Join sini lo njeng"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye op","Keluar lo njeng","Kaboor all"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
              ...
              if msg.from_ in owner:
                ...
                cl.sendText(msg.to,"Kami Siap Like Status Temen Lu\nKami Delay untuk beberapa Detik\nJangan perintah kami dulu sampai kami Selesai Ngelike")
                try:
                  autolike()
                except:
                  pass
        ...
        #-------------Fungsi Spam Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                ki.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                kk.sendText(msg.to,"P 􀔃??squared up!􏿿")
                cl.sendText(msg.to,"P 􀔃??squared up!􏿿")
                ki.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                kk.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                cl.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                ki.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
  ...
  #-----------------End-----------
                ...
                ki.sendText(msg.to,"Hi Kamu 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Hi Mantan 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Hi Gebetan :v 􀜁􀅔Har Har􏿿")
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Have a nice dream Dit 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Have a nice dream Dit 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Have a nice dream Dit 􀜁􀅔Har Har􏿿")
            elif msg.text in ["Cv say Dito Manis"]:
                ki.sendText(msg.to,"Dito Manis 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Dito Manis 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Dito Manis 􀜁􀅔Har Har􏿿")
            elif msg.text in ["#welcome" , "welkam" , "wc" , "Welkam" , "Wc"]:
                ki.sendText(msg.to,"Selamat datang di Grup Kita")
                kk.sendText(msg.to,"Jangan biasain sider , nimbrung aja :v & Jangan nakal ok!")
#-----------------------------------------------
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"Ditooo utama Always Present💦")
                ki.sendText(msg.to,"Ditooo V1 Always Present💦")
                kk.sendText(msg.to,"Ditooo V2 Always Present💦")
                kc.sendText(msg.to,"Ditooo V3 Always Present💦")
                ks.sendText(msg.to,"Ditooo V4 Always Present💦")
                cl.sendText(msg.to,"Semua udah hadir\nTinggal 1 aja yang belum hadir\nJODOH LU😂😂")
      #-------------Fungsi Respon Finish---------------------#
                            

      #-------------Fungsi Balesan Respon Start---------------------#
            elif msg.text in ["Vcs","Dam","Adam","Share"]:
                ki.sendText(msg.to,"OPEN VCS GRATIS\nADD ID LINE : http://line.me/ti/p/~dragonballsuperr\nDijamin crott💦😘")

      #-------------Fungsi Balesan Respon Finish---------------------#

       #-------------Fungsi Speedbot Start---------------------#
            elif msg.text in ["Speed","Sp","Cepet"]:
              if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "Sabar Dit...")
      ...
      #-------------Fungsi Banned Send Contact Start------------------#
              ...
              if msg.from_ in owner:
                ...
                cl.sendText(msg.to,"SC")
                ki.sendText(msg.to,"SC")
                kk.sendText(msg.to,"SC")
                kc.sendText(msg.to,"SC")
      #-------------Fungsi Banned Send Contact Finish------------------#
            elif msg.text in ["Creator"]:
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'uf2168bf25bf06251ed1fbfb6b7152412'}
              cl.sendText(msg.to,"Loading Please Wait ....")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"👆👆👆👆👆👆👆👆👆")
              cl.sendText(msg.to,"Tuh Creatornya yg Paling Manis SE-LINE 😜")
                
      #-------------Fungsi Chat ----------------
            elif msg.text in ["Woy","woy","Woi","Hai","bot","Bot"]:
                 quote = ['Cuma bisa mengagumi tanpa harus memiliki😂😂😂.','Kunci Untuk Bikin Pacar Bahagia itu cuma satu..\nIzinkan Pacarmu Untuk Selingkuh Coyyy ','Kadang yang di sayang suka gatau diri','Aku suka jerman , kamu suka belanda , aku suka beneran , kamu cuma bercanda']
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        ...
                        random.choice(KAC).kickoutFromGroup(msg.to,[jj])
                        random.choice(KAC).kickoutFromGroup(msg.to,[jj])
                    random.choice(KAC).sendText(msg.to,"Maaf ya gue tendang hehe :v")
                    random.choice(KAC).sendText(msg.to,"Maaf ya gue tendang hehe :v")
                    random.choice(KAC).sendText(msg.to,"Maaf ya gue tendang hehe :v")
                    random.choice(KAC).sendText(msg.to,"Maaf ya gue tendang hehe :v")
...
#---------------------
        if op.type == 17:
          ...
          random.choice(KAC).sendText(op.param1, "Welcome To My Grup  " + str(ginfo.name))
          random.choice(KAC).sendText(op.param1, "Owner Grup " + str(ginfo.name) + " :\n" + ginfo.creator.displayName)
          random.choice(KAC).sendText(op.param1,"Nimbrung aja yak  !!😊\nJangan baperan yak:v")
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by DITO BOT👈\n\nID LINE : http://line.me/ti/p/~ditopermana69")
          ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku dah Like Status Kamu\n\n Like back ya ke akun >> http://line.me/ti/p/~ditopermana69 😊")
          kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku dah Like Status Kamu\n\n Like back ya ke akun >> http://line.me/ti/p/~ditopermana69 😊")
          kc.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          kc.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku dah Like Status Kamu\n\n Like back ya ke akun >> http://line.me/ti/p/~ditopermana69 😊")
          ks.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ks.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku dah Like Status Kamu\n\n Like back ya ke akun >> http://line.me/ti/p/~ditopermana69 ??")
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"=====Ready=====\n>>Sell Stiker Line Murah<<\n1. 50c 3k\n2. 100c 6k\n3. 150c 9k\n BERLAKU KELIPATAN , PAYMENT VIA TSEL \n\nMau Tanya Terlebih Dahulu??\nMinat??? PM Id Line http://line.me/ti/p/~ditopermana69\nTRUSTED 100%\n===[★]DITO INSIDE[★]===")
          print "Like"
        except:
          pass
      else:
